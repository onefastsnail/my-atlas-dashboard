/**
 * Test file for Job: strava-activities
 */

var assert = require ('assert');
var strava_activities_SUT = require('../strava-activities');

var mockedConfig, mockedDependencies;

describe ('strava-activities test', function(){
  ...
  describe ('http request example tests', function(){
    it('should handle server errors', function (done){
      ...
      var config = {};
      strava_activities_SUT.onRun(config, mockedDependencies, function(err, data){
